...
define('ITEM_FIELD_CREATE_PLAYED_TIME', OBJECT_END+0x0039);
...
define('UNIT_FIELD_BYTES_0', OBJECT_END+0x0010);
define('UNIT_FIELD_HEALTH', OBJECT_END+0x0011);
define('UNIT_FIELD_POWER1', OBJECT_END+0x0012);
define('UNIT_FIELD_POWER2', OBJECT_END+0x0013);
define('UNIT_FIELD_POWER3', OBJECT_END+0x0014);
define('UNIT_FIELD_POWER4', OBJECT_END+0x0015);
define('UNIT_FIELD_POWER5', OBJECT_END+0x0016);
define('UNIT_FIELD_POWER6', OBJECT_END+0x0017);
define('UNIT_FIELD_POWER7', OBJECT_END+0x0018);
define('UNIT_FIELD_MAXHEALTH', OBJECT_END+0x0019);
define('UNIT_FIELD_MAXPOWER1', OBJECT_END+0x001A);
define('UNIT_FIELD_MAXPOWER2', OBJECT_END+0x001B);
define('UNIT_FIELD_MAXPOWER3', OBJECT_END+0x001C);
define('UNIT_FIELD_MAXPOWER4', OBJECT_END+0x001D);
define('UNIT_FIELD_MAXPOWER5', OBJECT_END+0x001E);
define('UNIT_FIELD_MAXPOWER6', OBJECT_END+0x001F);
define('UNIT_FIELD_MAXPOWER7', OBJECT_END+0x0020);
define('UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER', OBJECT_END+0x0021);
define('UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER', OBJECT_END+0x0028);
define('UNIT_FIELD_LEVEL', OBJECT_END+0x002F);
define('UNIT_FIELD_FACTIONTEMPLATE', OBJECT_END+0x0030);
define('UNIT_VIRTUAL_ITEM_SLOT_ID', OBJECT_END+0x0031);
define('UNIT_FIELD_FLAGS', OBJECT_END+0x0034);
define('UNIT_FIELD_FLAGS_2', OBJECT_END+0x0035);
define('UNIT_FIELD_AURASTATE', OBJECT_END+0x0036);
define('UNIT_FIELD_BASEATTACKTIME', OBJECT_END+0x0037);
define('UNIT_FIELD_RANGEDATTACKTIME', OBJECT_END+0x0039);
define('UNIT_FIELD_BOUNDINGRADIUS', OBJECT_END+0x003A);
define('UNIT_FIELD_COMBATREACH', OBJECT_END+0x003B);
define('UNIT_FIELD_DISPLAYID', OBJECT_END+0x003C);
define('UNIT_FIELD_NATIVEDISPLAYID', OBJECT_END+0x003D);
define('UNIT_FIELD_MOUNTDISPLAYID', OBJECT_END+0x003E);
define('UNIT_FIELD_MINDAMAGE', OBJECT_END+0x003F);
define('UNIT_FIELD_MAXDAMAGE', OBJECT_END+0x0040);
define('UNIT_FIELD_MINOFFHANDDAMAGE', OBJECT_END+0x0041);
define('UNIT_FIELD_MAXOFFHANDDAMAGE', OBJECT_END+0x0042);
define('UNIT_FIELD_BYTES_1', OBJECT_END+0x0043);
define('UNIT_FIELD_PETNUMBER', OBJECT_END+0x0044);
define('UNIT_FIELD_PET_NAME_TIMESTAMP', OBJECT_END+0x0045);
define('UNIT_FIELD_PETEXPERIENCE', OBJECT_END+0x0046);
define('UNIT_FIELD_PETNEXTLEVELEXP', OBJECT_END+0x0047);
define('UNIT_DYNAMIC_FLAGS', OBJECT_END+0x0048);
define('UNIT_CHANNEL_SPELL', OBJECT_END+0x0049);
...
define('PLAYER_VISIBLE_ITEM_1_ENTRYID', UNIT_END+0x006E);
define('PLAYER_VISIBLE_ITEM_1_ENCHANTMENT', UNIT_END+0x006F);
define('PLAYER_VISIBLE_ITEM_2_ENTRYID', UNIT_END+0x0070);
define('PLAYER_VISIBLE_ITEM_2_ENCHANTMENT', UNIT_END+0x0071);
define('PLAYER_VISIBLE_ITEM_3_ENTRYID', UNIT_END+0x0072);
define('PLAYER_VISIBLE_ITEM_3_ENCHANTMENT', UNIT_END+0x0073);
define('PLAYER_VISIBLE_ITEM_4_ENTRYID', UNIT_END+0x0074);
define('PLAYER_VISIBLE_ITEM_4_ENCHANTMENT', UNIT_END+0x0075);
define('PLAYER_VISIBLE_ITEM_5_ENTRYID', UNIT_END+0x0076);
define('PLAYER_VISIBLE_ITEM_5_ENCHANTMENT', UNIT_END+0x0077);
define('PLAYER_VISIBLE_ITEM_6_ENTRYID', UNIT_END+0x0078);
define('PLAYER_VISIBLE_ITEM_6_ENCHANTMENT', UNIT_END+0x0079);
define('PLAYER_VISIBLE_ITEM_7_ENTRYID', UNIT_END+0x007A);
define('PLAYER_VISIBLE_ITEM_7_ENCHANTMENT', UNIT_END+0x007B);
define('PLAYER_VISIBLE_ITEM_8_ENTRYID', UNIT_END+0x007C);
define('PLAYER_VISIBLE_ITEM_8_ENCHANTMENT', UNIT_END+0x007D);
define('PLAYER_VISIBLE_ITEM_9_ENTRYID', UNIT_END+0x007E);
define('PLAYER_VISIBLE_ITEM_9_ENCHANTMENT', UNIT_END+0x007F);
define('PLAYER_VISIBLE_ITEM_10_ENTRYID', UNIT_END+0x0080);
define('PLAYER_VISIBLE_ITEM_10_ENCHANTMENT', UNIT_END+0x0081);
define('PLAYER_VISIBLE_ITEM_11_ENTRYID', UNIT_END+0x0082);
define('PLAYER_VISIBLE_ITEM_11_ENCHANTMENT', UNIT_END+0x0083);
define('PLAYER_VISIBLE_ITEM_12_ENTRYID', UNIT_END+0x0084);
define('PLAYER_VISIBLE_ITEM_12_ENCHANTMENT', UNIT_END+0x0085);
define('PLAYER_VISIBLE_ITEM_13_ENTRYID', UNIT_END+0x0086);
define('PLAYER_VISIBLE_ITEM_13_ENCHANTMENT', UNIT_END+0x0087);
define('PLAYER_VISIBLE_ITEM_14_ENTRYID', UNIT_END+0x0088);
define('PLAYER_VISIBLE_ITEM_14_ENCHANTMENT', UNIT_END+0x0089);
define('PLAYER_VISIBLE_ITEM_15_ENTRYID', UNIT_END+0x008A);
define('PLAYER_VISIBLE_ITEM_15_ENCHANTMENT', UNIT_END+0x008B);
define('PLAYER_VISIBLE_ITEM_16_ENTRYID', UNIT_END+0x008C);
define('PLAYER_VISIBLE_ITEM_16_ENCHANTMENT', UNIT_END+0x008D);
define('PLAYER_VISIBLE_ITEM_17_ENTRYID', UNIT_END+0x008E);
define('PLAYER_VISIBLE_ITEM_17_ENCHANTMENT', UNIT_END+0x008F);
define('PLAYER_VISIBLE_ITEM_18_ENTRYID', UNIT_END+0x0090);
define('PLAYER_VISIBLE_ITEM_18_ENCHANTMENT', UNIT_END+0x0091);
define('PLAYER_VISIBLE_ITEM_19_ENTRYID', UNIT_END+0x0092);
define('PLAYER_VISIBLE_ITEM_19_ENCHANTMENT', UNIT_END+0x0093);
define('PLAYER_CHOSEN_TITLE', UNIT_END+0x0094);
define('PLAYER_FAKE_INEBRIATION', UNIT_END+0x0095);
define('PLAYER_FIELD_INV_SLOT_HEAD', UNIT_END+0x0096);
define('PLAYER_FIELD_PACK_SLOT_1', UNIT_END+0x00C4);
define('PLAYER_FIELD_BANK_SLOT_1', UNIT_END+0x00E4);
define('PLAYER_FIELD_BANKBAG_SLOT_1', UNIT_END+0x011C);
define('PLAYER_FIELD_VENDORBUYBACK_SLOT_1', UNIT_END+0x012A);
define('PLAYER_FIELD_KEYRING_SLOT_1', UNIT_END+0x0142);
define('PLAYER_FIELD_CURRENCYTOKEN_SLOT_1', UNIT_END+0x0182);
define('PLAYER_FARSIGHT', UNIT_END+0x01C2);
define('PLAYER__FIELD_KNOWN_TITLES', UNIT_END+0x01C4);
define('PLAYER__FIELD_KNOWN_TITLES1', UNIT_END+0x01C6);
define('PLAYER__FIELD_KNOWN_TITLES2', UNIT_END+0x01C8);
define('PLAYER_FIELD_KNOWN_CURRENCIES', UNIT_END+0x01CA);
define('PLAYER_XP', UNIT_END+0x01CC);
define('PLAYER_NEXT_LEVEL_XP', UNIT_END+0x01CD);
define('PLAYER_SKILL_INFO_1_1', UNIT_END+0x01CE);
define('PLAYER_CHARACTER_POINTS1', UNIT_END+0x034E);
define('PLAYER_CHARACTER_POINTS2', UNIT_END+0x034F);
define('PLAYER_TRACK_CREATURES', UNIT_END+0x0350);
define('PLAYER_TRACK_RESOURCES', UNIT_END+0x0351);
define('PLAYER_BLOCK_PERCENTAGE', UNIT_END+0x0352);
define('PLAYER_DODGE_PERCENTAGE', UNIT_END+0x0353);
define('PLAYER_PARRY_PERCENTAGE', UNIT_END+0x0354);
define('PLAYER_EXPERTISE', UNIT_END+0x0355);
define('PLAYER_OFFHAND_EXPERTISE', UNIT_END+0x0356);
define('PLAYER_CRIT_PERCENTAGE', UNIT_END+0x0357);
define('PLAYER_RANGED_CRIT_PERCENTAGE', UNIT_END+0x0358);
define('PLAYER_OFFHAND_CRIT_PERCENTAGE', UNIT_END+0x0359);
define('PLAYER_SPELL_CRIT_PERCENTAGE1', UNIT_END+0x035A);
define('PLAYER_SHIELD_BLOCK', UNIT_END+0x0361);
define('PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE', UNIT_END+0x0362);
define('PLAYER_EXPLORED_ZONES_1', UNIT_END+0x0363);
define('PLAYER_REST_STATE_EXPERIENCE', UNIT_END+0x03E3);
define('PLAYER_FIELD_COINAGE', UNIT_END+0x03E4);
define('PLAYER_FIELD_MOD_DAMAGE_DONE_POS', UNIT_END+0x03E5);
define('PLAYER_FIELD_MOD_DAMAGE_DONE_NEG', UNIT_END+0x03EC);
define('PLAYER_FIELD_MOD_DAMAGE_DONE_PCT', UNIT_END+0x03F3);
define('PLAYER_FIELD_MOD_HEALING_DONE_POS', UNIT_END+0x03FA);
define('PLAYER_FIELD_MOD_HEALING_PCT', UNIT_END+0x03FB);
define('PLAYER_FIELD_MOD_HEALING_DONE_PCT', UNIT_END+0x03FC);
define('PLAYER_FIELD_MOD_TARGET_RESISTANCE', UNIT_END+0x03FD);
define('PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE', UNIT_END+0x03FE);
define('PLAYER_FIELD_BYTES', UNIT_END+0x03FF);
define('PLAYER_AMMO_ID', UNIT_END+0x0400);
define('PLAYER_SELF_RES_SPELL', UNIT_END+0x0401);
define('PLAYER_FIELD_PVP_MEDALS', UNIT_END+0x0402);
define('PLAYER_FIELD_BUYBACK_PRICE_1', UNIT_END+0x0403);
define('PLAYER_FIELD_BUYBACK_TIMESTAMP_1', UNIT_END+0x040F);
define('PLAYER_FIELD_KILLS', UNIT_END+0x041B);
define('PLAYER_FIELD_TODAY_CONTRIBUTION', UNIT_END+0x041C);
define('PLAYER_FIELD_YESTERDAY_CONTRIBUTION', UNIT_END+0x041D);
define('PLAYER_FIELD_LIFETIME_HONORBALE_KILLS', UNIT_END+0x041E);
define('PLAYER_FIELD_BYTES2', UNIT_END+0x041F);
define('PLAYER_FIELD_WATCHED_FACTION_INDEX', UNIT_END+0x0420);
define('PLAYER_FIELD_COMBAT_RATING_1', UNIT_END+0x0421);
define('PLAYER_FIELD_ARENA_TEAM_INFO_1_1', UNIT_END+0x043A);
define('PLAYER_FIELD_HONOR_CURRENCY', UNIT_END+0x044F);
define('PLAYER_FIELD_ARENA_CURRENCY', UNIT_END+0x0450);
define('PLAYER_FIELD_MAX_LEVEL', UNIT_END+0x0451);
define('PLAYER_FIELD_DAILY_QUESTS_1', UNIT_END+0x0452);
define('PLAYER_RUNE_REGEN_1', UNIT_END+0x046B);
define('PLAYER_NO_REAGENT_COST_1', UNIT_END+0x046F);
define('PLAYER_FIELD_GLYPH_SLOTS_1', UNIT_END+0x0472);
define('PLAYER_FIELD_GLYPHS_1', UNIT_END+0x0478);
define('PLAYER_GLYPHS_ENABLED', UNIT_END+0x047E);
define('PLAYER_FIELD_PADDING', UNIT_END+0x047F);
