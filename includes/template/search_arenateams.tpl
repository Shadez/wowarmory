...
{literal}
		$(document).ready(function(){	
			...
			//store filters
{/literal}
			initSearchResults("arenateams", "{$searchQuery}", "", filterValues, "6");
{literal}	});	{/literal}
	</script>
<div class="tabs">
...
<h3 id="replaceHeaderTitle">{#armory_searchpage_arenateams#}</h3>
</b>
</blockquote>
...
<thead>
<tr class="masthead">
<th style="width: 100%;"><a>{#armory_searcharena_name#}<span class="sortArw"></span></a></th><th><a>{#armory_searcharena_rating#}<span class="sortArw"></span></a></th><th><a>{#armory_searcharena_category#}<span class="sortArw"></span></a></th><th style="min-width: 150px;"><a>{#armory_searchpage_realmname#}<span class="sortArw"></span></a></th><th style="min-width: 150px;"><a>{#armory_searchpage_battlegroup#}<span class="sortArw"></span></a></th><th style="min-width: 100px;"><a>{#armory_searchpage_faction#}<span class="sortArw"></span></a></th><th style="width: 120px;"><a>{#armory_searchpage_relevance#}<span class="sortArw"></span></a></th>
</tr>
</thead>
<tbody>
{foreach from=$arenateamsResult item=team}
<tr>
<td><a href="team-info.xml?r={$realmName}&amp;ts={$team.type}&amp;t={$team.name}&amp;select=">{$team.name}</a></td><td class="rightNum"><span style="font-weight: bold">{$team.rating}</span></td><td class="centNum">{$team.type}{#armory_searcharena_versus#}{$team.type}</td><td>{$realmName}</td><td>{#armory_searchpage_battlegroup_none#}</td><td class="centNum"><img class="staticTip" onmouseover="setTipText('{get_wow_faction race=$team.race}');" src="images/icons/faction/icon-{get_wow_faction race=$team.race numeric=true}.gif"></td><td><span style="display: none;">100%</span><q class="staticTip" onmouseover="setTipText('100%');"><del class="rel-container"><a><em style="width:100%"></em></a></del></q></td>
</tr>
{/foreach}
</tbody>
</table>
