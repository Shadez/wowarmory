...
<div class="profile">
<script src="_js/guild/bank-contents.js" type="text/javascript"></script>
...
<div class="filterBox">{#armory_guild_bank_contents_filter_name#}: <br />
<input class="filterInput" id="filItemName" maxlength="40" size="40" style="width: 200px;" type="text" value="" />
</div>
<div class="filterBox">{#armory_guild_bank_contents_filter_quality#}: <br />
<select id="filRarity" onchange="runBankContentFilters()"><option value="-1">{#armory_guild_bank_contents_filter_alltypes#}</option><option value="0">{#armory_guild_bank_quality1#}</option><option value="1">{#armory_guild_bank_quality2#}</option><option value="2">{#armory_guild_bank_quality3#}</option><option value="3">{#armory_guild_bank_quality4#}</option><option value="4">{#armory_guild_bank_quality5#}</option><option value="5">{#armory_guild_bank_quality6#}</option><option value="6">{#armory_guild_bank_quality7#}</option></select>
</div>
<div class="filterBox">{#armory_guild_bank_contents_filter_category#}: <br />
<select id="filItemType" onchange="runBankContentFilters()"><option value="-1">{#armory_guild_bank_contents_filter_alltypes#}</option><option>{#armory_guild_bank_type1#}</option><option>{#armory_guild_bank_type2#}</option><option>{#armory_guild_bank_type3#}</option><option>{#armory_guild_bank_type4#}</option><option>{#armory_guild_bank_type5#}</option><option>{#armory_guild_bank_type6#}</option><option>{#armory_guild_bank_type7#}</option><option>{#armory_guild_bank_type8#}</option><option>{#armory_guild_bank_type9#}</option><option>{#armory_guild_bank_type10#}</option><option>{#armory_guild_bank_type11#}</option><option>{#armory_guild_bank_type12#}</option><option>{#armory_guild_bank_type13#}</option><option>{#armory_guild_bank_type14#}</option><option>{#armory_guild_bank_type15#}</option></select>
</div>
<div class="filterBox">{#armory_guild_bank_contents_filter_deposit#}: <br />
<select id="filTab" onchange="runBankContentFilters()" style="width: 100px;"><option value="-1">{#armory_guild_info_all_ranks#}</option>{foreach from=$gbtabs item=tab}<option value="{$tab.id}">{$tab.name}</option>{/foreach}</select>
</div>
<div class="clear"></div>
<div id="filterButtonHolder">
<a href="javascript:void(0)" id="runFilterButton" onclick="resetBankContentsFilters();" style="cursor: pointer;"><span class="btnRight">{#armory_guild_info_clear_critera#}</span></a>
</div>
</div>
...
<thead>
<tr class="masthead">
<th style="width: 350px; text-align:left;"><a>{#armory_item_info_items_string#}<span class="sortArw"></span></a></th><th style="width: 200px; text-align:left;"><a>{#armory_guild_bank_type#}<span class="sortArw"></span></a></th><th style="width: 150px; text-align:left;"><a>{#armory_guild_bank_subtype#}<span class="sortArw"></span></a></th><th style="text-align:left; min-width: 100px;"><a>{#armory_guild_bank_deposit#}<span class="sortArw"></span></a></th>
</tr>
</thead>
<tbody>
