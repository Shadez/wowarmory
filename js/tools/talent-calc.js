...
var ICON_PREFIX      = '/wow-icons/images/_talents31x31/';
var ICON_PREFIX_GREY = '/wow-icons/images/_talents31x31/grey/';
var ICON_TREE_PREFIX = '/wow-icons/images/21x21/'; 
	...
	if(familyId > 0)
	{
		if(familyId != whichClass)
		{
			...
			if(pageMode == 'calc') {
				...
				talentTrees[currentPetTree].iconDiv.css('background-image', 'url(' + ICON_TREE_PREFIX + petFamilies[whichClass].icon + '.jpg)');
			}
		}
	}
